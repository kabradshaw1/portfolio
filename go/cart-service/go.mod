module github.com/kabradshaw1/portfolio/go/cart-service
...
require (
	...
	github.com/kabradshaw1/portfolio/go/product-service v0.0.0-20260421031427-3f8b9f52b375 // indirect
